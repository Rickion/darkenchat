...
const server = new McpServer(
  ...
  },
  {
    ...
    instructions: [
      ...
      '• See shared media — when a member sends an image/audio/file it arrives as a message with a',
      '  `media` object; call fetch_media with its mediaId to pull the bytes (inline image/audio',
      '  block, or a temp file path). Replies carry a `quote` referencing the message they answer.',
      '',
